        ...
        sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            flex flex-col items-center lg:items-start">
              ...
              ">Your Image on a <span className="bg-green-600 
              px-2  text-white">Custom</span> Phone Case
              </h1>
              ...
              lg:text-left text-balance md:text-wrap">
                ...
                <span className="font-semibold">
                  one of one</span> phone case.
                CaseCobra allows you to protect your memories, not just your phone case.
              </p>

              <ul className="space-y-2 mt-8 text-left font-medium flex flex-col
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div className="flex -space-x-4">
                  ...
                  <img className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-slate-100"
